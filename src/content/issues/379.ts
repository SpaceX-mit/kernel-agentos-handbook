  ...
  spread: {
    ...
    sections: [
      ...
      },
      {
        ...
        headingJp: '裏表紙という面',
        paragraphs: [
          'Magazines have backs. POPEYE has its back-cover Sailor Popeye illustration on every issue — the same character, the same brushwork, recognizable from across a newsstand. Brutus uses the back for a recurring food still life. PAPERSKY, when it carries one, runs a single quiet image with the issue’s place name set small below it. The back cover is a surface a magazine cannot avoid having, because it is the surface a reader sees as often as the front — every time the issue is set down face-up on a table.',
