/* ──────────────────────────────────────────────────────────────
   ...
   substrate reaching the consumer surface. 395 steps out of the
...
export const ISSUE_395: IssueRecord = {
  ...
  backCover: {
    ...
    subjectJp: '電信機の圧盤',
    stock: 'ivory',
    image: '/back-covers/395-teletype.jpg',
  ...
  spread: {
    ...
    bulletin: {
      ...
      attribution: 'KERNEL.CHAT · DISPATCH · 395',
    },
    ...
    terminator: 'END OF DISPATCH · KERNEL.CHAT/395 · FILED 28 MAY · WEEK OF 18–24 MAY · INK STILL WET',
  },
