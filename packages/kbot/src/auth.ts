...
export const PROVIDERS: Record<ByokProvider, ProviderConfig> = {
  ...
  mistral: {
    ...
    fastModel: 'mistral-small-2503',
    inputCost: 2.0,
    outputCost: 6.0,
    authHeader: 'bearer',
    models: ['mistral-large-latest', 'mistral-small-2503', 'mistral-small-latest', 'codestral-latest', 'mistral-saba-latest', 'pixtral-large-latest', 'voxtral-tts-latest'],
  },
  xai: {
    name: 'xAI (Grok)',
