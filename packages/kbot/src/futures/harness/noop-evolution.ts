...
export class NoopEvolutionAgent implements EvolutionAgent {
  /**
   ...
   */
  async evolve(history: EvolutionRecord[], best: Harness): Promise<Harness> {
...
export function createNoopEvolutionAgent(): EvolutionAgent {
